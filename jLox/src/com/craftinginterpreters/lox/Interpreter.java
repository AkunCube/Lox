...
public class Interpreter implements Expr.Visitor<Object>,
	...
	/**
	 * @return 'false' and 'nil' are false.
	 * anything else is truth.
	 */
	...
	public Void visitClassStmt(Stmt.Class stmt) {
		// first, we begin with its super class.
		...
		// change the environment to reflect the `super`.
		if (stmt.superclass != null) {
		...
		LoxClass klass = new LoxClass(stmt.name.lexeme,
						(LoxClass) superClass, methods, staticMethods);

		// throw away the super class environment.
		if (stmt.superclass != null) {
